            ...
            // If the specifed path is a directory 
                ...
                if (options.recursive) {
                    router.get('/*', (params, client) => {
                        ...
                        console.log(reqpath);
                        // if (!options.recursive && ((reqpath.match(/\/./g) || []).length) > 1) {
                        //     throw [403, 'Recursive folder is disabled'];
                        // }
