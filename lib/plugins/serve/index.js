 ...
 * @property {boolean} [noFilename=false] - Whether to serve file as the root of the router.
 * Use this option to serve a single (cached) file as the router itself instead of the filename.
 * Does not work on cached file.
 */
