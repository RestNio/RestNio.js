...
class Parser {
     ...
     */
    static async parseFullHttpParams(request, url) {
        switch(request.method) {
            ...
            case 'PUT': {
                ...
                request.on('data', (chunk) => {
                    ...
                    return Parser.parseQueryStringParams(Buffer.concat(data).toString());
                });
                break;
            }
            default: {
                return Parser.parseQueryStringParams(url.search);
            }
        }
    }
