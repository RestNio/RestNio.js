 ...
 * where only the specified options are allowed.
 * @property {ParamDef} time - Required param with relative time in millis.
 * Param ultimately returns a number. Param can be given as zeit/ms string.
 * IE: 555 => 555, "1s" => 1000 etc.
 * @property {ParamDef} relativeDate - Param with relative datetime.
